    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            while (true) {
                ...
                System.out.println(
                        incomingPacket.getAddress().getHostAddress() + ":" + incomingPacket.getPort() + " > " + s);

                if (s.equalsIgnoreCase("bye")) {
                    String reply = new String("Bye");
                    msg = reply.getBytes();

                    DatagramPacket sendPacket = new DatagramPacket(msg, msg.length, incomingPacket.getAddress(),
